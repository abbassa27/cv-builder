...
os.makedirs("src/app/create-cv", exist_ok=True)


# 1. تعديل layout.tsx ليضم Navbar في كل الصفحات
...
# 2. صفحة إنشاء سيرة ذاتية
with open("src/app/create-cv/page.tsx", "w", encoding="utf-8") as f:
    f.write('''\
"use client"
