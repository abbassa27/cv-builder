      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
            ...
            إلى{" "}
            <span className="bg-gradient-to-l from-indigo-600 to-green-500 bg-clip-text text-transparent">
              دقائق من النجاح
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* CV Builder Way */}
          <div className="bg-indigo-50/50 rounded-2xl p-8 border border-indigo-200 shadow-lg shadow-indigo-100/50">
            <h3 className="text-lg font-bold text-indigo-600 mb-4">✨ طريقة CV Builder</h3>
            <div className="text-2xl font-bold text-indigo-600 mb-4">15-30 دقيقة</div>
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-center gap-2 text-sm text-gray-600">
                  <span className="w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 text-xs flex-shrink-0">✓</span>
                  {item}
                </li>
              ))}
            </ul>
